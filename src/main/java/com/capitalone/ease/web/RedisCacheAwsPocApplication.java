...
public class RedisCacheAwsPocApplication {
    private static final Logger logger = LoggerFactory.getLogger(RedisCacheAwsPocApplication.class);

    public static void main(String[] args) {
        SpringApplication.run(RedisCacheAwsPocApplication.class, args);
    }
    ...
    protected static class LocalCacheConfiguration {
        ...
        public CacheManager createSimpleCacheManager() {
            ...
            caches.add(new ConcurrentMapCache("awspoccacheredis"));
    ...
    @Configuration
    @EnableElastiCache({@CacheClusterConfig(name = "awspoccacheredis", expiration = 23)})
    @Profile("aws")
